    ...
    <View style={itemVertical.cardItem}>
          ...
          <View>
            <View style={itemVertical.cardIcon}>
              <TouchableOpacity onPress={onPress}>
                ...
                <AddSquare color={colors.darkModeBlack()} variant={variant} size={20} />
              </TouchableOpacity>
            </View>
          </View>   
      ...
      <View style={{flex: 1}}>
          <View
            ...
            <Text style={{fontSize: 12, color: '#001524'}}>{itemVertical.cardjenis}{item.jenis}</Text>
            <Text style={{fontSize: 15, color: '#001524'}}>{itemVertical.cardjenis}{item.kamera}</Text>
            <Text style={{fontSize: 17, color: '#001524'}}>{itemVertical.cardjenis}{item.harga}</Text>
