    ...
    try {
      ...
      await firestore()
        ...
        .set({
          fullName,
          email,
          photoUrl: `https://cdns.klimg.com/merdeka.com/i/w/news/2023/01/12/1511073/540x270/fantastis-ronaldo-habiskan-uang-setara-satu-stadion-di-indonesia-hanya-untuk-tidur-cristiano-ronaldo.jpg`,
          followersCount: 0,
          followingCount: 0,
          totalPost: 0,
          createdAt: new Date(),
        ...
        <View style={[styles.container, {paddingVertical}]}>
          <View>
            ...
            <Text style={styles.caption}>
              Silahkan Mendaftar untuk dapat Login
            </Text>
          ...
          <View style={{gap: 10}}>
            ...
            <View style={{flexDirection: 'row', gap: 5, alignSelf: 'center'}}>
              <Text style={[button.label, {color: colors.black()}]}>
                Apakah mempunyai Akun ?
              </Text>
              <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                <Text style={[button.label, {color: '#706233'}]}>
                  Log in
                </Text>
              </TouchableOpacity>
            </View>
